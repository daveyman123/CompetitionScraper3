...
class AStorageInnLemay(scrapy.Spider):
	...
	def parse(self, response):
		...
		#url = "http://www.python.org"
                url='https://www.storageinns.net/self-storage/mo/ballwin/manchester-road/unit-sizes-prices#/units?category=all'
		...
		#driver2 = webdriver.Firefox()
                ...
                outside_units = ["5 x 6","6 x 8", "6 x 12", "10 x 16","10 x 14", "8 x 10","10 x 10","10 x 12","10 x 30","10 x 20", "10 x 25"]
		scheight = .1
		while scheight < 9.9:
