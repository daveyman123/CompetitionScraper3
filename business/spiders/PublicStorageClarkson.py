...
class MySpider(scrapy.Spider):
	...
	def parse(self, response):
		...
		outside_units = ["5' x 10'","5' x 15'","8' x 10'","10' x 10'","10' x 20'","10' x 25'","10' x 30'","10' x 24'", "10' x 15'"]
		...
		for n in range(len(sizeTagz)):
                        ...
                        if (sizeTagz[n]).get_text() in outside_units or (sizeTagz[n]).get_text() in inside_units:
                        	if (sizeTagz[n]).get_text() not in size:
                                	if "Inside" in ((typesTagz[n]).get_text()) or "Outside" in ((typesTagz[n]).get_text()):
