...
class AStorageInnLemay(scrapy.Spider):
	...
	def parse(self, response):
		...
		#url = "http://www.python.org"
                url='https://www.storageinns.net/self-storage/mo/saint-charles/old-highway-94/unit-sizes-prices#/units?category=all'
		...
		#driver2 = webdriver.Firefox()
                ...
                outside_units = ["5 x 6", "6 x 12", "10 x 16","12 x 12", "8 x 10","10 x 16","10 x 12", "10 x 24"]
		scheight = .1
		while scheight < 9.9:
