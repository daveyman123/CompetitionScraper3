...
from business.spiders.PublicStorageDoug import *
from scrapy.utils.project import get_project_settings

def sendmail():

	process = CrawlerProcess(get_project_settings())
	process.crawl(AStorageInnCave)
	process.crawl(MySpider1)
	process.crawl(MySpider2)
	process.crawl(ExtraSpaceCave)
	process.crawl(StPetersCave)
...
def monitor():
	...
	time.sleep(3)
		...
		if curr_hour == 6 and curr_min == 15:
			sendmail()
			sleep()
